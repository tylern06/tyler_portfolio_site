export const personalInfo = {
  ...
  tagline:
    'Full stack engineer with 8+ years of experience designing high-performance web and mobile applications in FinTech and warehouse management.',
  email: 'tynguyen06@gmail.com',
  location: 'Seattle, WA',
  linkedin: 'https://www.linkedin.com/in/tyler-nguyen',
  github: 'https://github.com/tylern06',
...
export const experience = [
  {
    ...
    location: 'Seattle, WA',
    description:
      'Led modernization of a legacy FinTech lender platform and built end-to-end product features serving lending operations.',
    highlights: [
  ...
  },
  {
    ...
    location: 'Seattle, WA',
    description:
      'Built and maintained web and mobile applications for warehouse management, QA/QC, and ERP integrations.',
    highlights: [
  ...
  },
  {
    ...
    location: 'Seattle, WA',
    description:
      'Developed responsive, cross-browser websites from design mockups and improved frontend build workflows.',
    highlights: [
...
export const projects = [
  {
    ...
    description:
      'End-to-end referral platform for a FinTech lender enabling partner registration, agreement signing, and deal submissions — with an admin dashboard tracking referrals through payment.',
  ...
  },
  {
    ...
    description:
      'Mobile warehouse management system built with React Native and Expo, featuring gRPC communication with C# backend services for strongly typed, low-latency warehouse operations.',
  ...
  },
  {
    ...
    description:
      'APIs and scheduling algorithms to generate optimized pallet picklists for a robotic crane system, integrated with real-time production reporting and industrial scale hardware.',
...
export const skills = {
  ...
  Backend: ['Node.js', 'Express', 'Python', 'Flask', 'RESTful APIs', 'gRPC'],
  Databases: ['MongoDB', 'PostgreSQL', 'MySQL', 'Microsoft SQL Server'],
  'DevOps & Testing': [
    'AWS (S3, Lambda, EC2, Cognito, CloudWatch)',
    'Docker',
    'Kubernetes',
    'Jest',
    'Vitest',
